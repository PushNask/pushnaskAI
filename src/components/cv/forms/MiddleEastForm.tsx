...
const formSchema = z.object({
  ...
  photo: z.string().min(1, "Photo is required for Middle East CV"),
  ...
  references: z.string().min(10, "References are required for Middle East CV"),
});
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Your marital status" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Professional references" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
